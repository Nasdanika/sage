...
/**
 * This is the item provider adapter for a {@link org.nasdanika.sage.HierarchicalModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HierarchicalModelElementItemProvider extends ModelElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HierarchicalModelElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((HierarchicalModelElement<?>) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_HierarchicalModelElement_type")
				: getString("_UI_HierarchicalModelElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HierarchicalModelElement.class)) {
